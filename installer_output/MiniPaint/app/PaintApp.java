...
public class PaintApp implements CanvasListener {
    ...
    private void init() {
        ...
        addToolButton(tools, "Béz", "Draw Bézier Curve (4 clicks)", ToolMode.DRAW_BEZIER, faFont);
        addToolButton(tools, "Herm", "Draw Hermite Curve (2 clicks + 2 drags)", ToolMode.DRAW_HERMITE, faFont);
