...
O instalador já inclui o Java Runtime embutido — **não é necessário ter Java instalado**.

1. Execute o arquivo `installer_output/MiniPaint_Setup_v1.0.0.exe`
2. Siga o assistente de instalação (escolha o diretório e atalhos)
3. Ao finalizar, o MiniPaint pode ser aberto diretamente
4. Após instalado, abra pelo **Menu Iniciar → MiniPaint** ou pelo atalho na Área de Trabalho

Para desinstalar: **Painel de Controle → Programas → MiniPaint → Desinstalar**

### Opção 2: Compilação manual (requer JDK 8+)
